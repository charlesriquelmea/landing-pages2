...
export default function InstructorSecondSection() {
  const instructor = {
    name: "lorem ipsum",
    role: "lorem ipsum",
    ...
    expertise: [
      ...
      "lorem ipsum incididunt ut labore",
    ],
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-gradient-to-r from-orange-500 to-pink-500 shadow-xl">
              <Image src="/placeholder.svg" alt={instructor.name} fill className="object-cover" />
            </div>
          </motion.div>
