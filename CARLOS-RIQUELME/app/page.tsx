...
const PROJECTS = [
  {
    ...
    status: "Design",
    description:
      "Dise\u00f1o responsive en HTML5 desde cero, pensado dispositivo por dispositivo.",
...
const TECH_STACK: { category: string; items: { name: string; useCase: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "GPT-5.2", useCase: "Razonamiento avan\u00e7ado" },
    ],
  },
  {
  ...
  return (
    <SectionWrapper>
      ...
      >
        ...
        >
          {
            "No ense\u00f1o desde un aula. Construyo en la trinchera. Crec\u00ed entendiendo algo inc\u00f3modo: el sistema rara vez est\u00e1 dise\u00f1ado para hacerte libre; est\u00e1 dise\u00f1ado para hacerte funcional. Esa revelaci\u00f3n no me volvi\u00f3 c\u00ednico, me volvi\u00f3 intencional: si la estructura no ayuda, entonces se dise\u00f1a una nueva."
          }
        </motion.p>
    ...
    <SectionWrapper id="la-cancha">
      ...
      >
        <SectionHeader
          chip="La Cancha"
          title="Lo construido"
          subtitle="Esto no es un curso. Es el blueprint de un constructor que ya lo hizo."
        />
      </motion.div>
    ...
    <SectionWrapper id="ship-fast">
      <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-16">
        ...
        >
          ...
          >
            Importamos mindset de innovaci\u00f3n, pero lo adaptamos a realidad
            latina.
          </motion.p>
          ...
          >
            {[
              ...
              "Prototipo r\u00e1pido con validaci\u00f3n",
